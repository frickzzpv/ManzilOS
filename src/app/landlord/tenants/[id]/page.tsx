      ...
      <Card className="mb-8">
        ...
        <CardContent>
            <div className="flex items-center space-x-4">
                ...
                <Badge variant="outline">Screening: {tenant.screeningStatus || 'Not Started'}</Badge>
                {(!tenant.screeningStatus || tenant.screeningStatus === 'NOT_STARTED') && (
                    <Button size="sm" onClick={() => alert('This would trigger the tenant screening process.')}>Screen Tenant</Button>
                )}
            </div>
        </CardContent>
      </Card>
